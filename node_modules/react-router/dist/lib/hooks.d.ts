...
import type { Blocker, BlockerFunction, Location, ParamParseKey, Params, Path, PathMatch, PathPattern, RelativeRoutingType, Router as RemixRouter, RevalidationState, To, UIMatch } from "../../../../myapp/node_modules/@remix-run/router/dist";
import { Action as NavigationType } from "../../../../myapp/node_modules/@remix-run/router/dist";
import type { NavigateOptions, RouteContextObject, RouteMatch, RouteObject } from "react-router/dist/lib/context";
/**
 ...
 */
export declare function useNavigation(): import("../../../../myapp/node_modules/@remix-run/router/dist").Navigation;
/**
