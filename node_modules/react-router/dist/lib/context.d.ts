...
import type { AgnosticIndexRouteObject, AgnosticNonIndexRouteObject, AgnosticRouteMatch, History, LazyRouteFunction, Location, Action as NavigationType, RelativeRoutingType, Router, StaticHandlerContext, To, TrackedPromise } from "../../../../myapp/node_modules/@remix-run/router/dist";
...
export declare const DataRouterStateContext: React.Context<import("../../../../myapp/node_modules/@remix-run/router/dist").RouterState | null>;
